...
<div class="center-screen">
  <div class="card-auth">
    ...
    <h5 class="text-center mb-3 fw-bold text-success">Login Terapis</h5>
    ...
    <form method="POST" action="{{ route('terapis.login.submit') }}">
      @csrf
      ...
      <div class="d-grid mb-2">
        <button class="btn btn-success">Login sebagai Terapis</button>
      </div>

      <div class="small-muted mb-3">
        Belum punya akun? <a href="{{ route('terapis.register') }}">Daftar</a>
      </div>

      <div class="text-center">
        <small><a href="{{ route('login') }}" class="text-muted">← Kembali ke Login User</a></small>
      </div>
    </form>
  </div>
</div>
